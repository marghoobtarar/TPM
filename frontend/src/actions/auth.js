...
export const addListing = (data)=>async dispatch=>{
    console.log('this is adding the data',data)
    dispatch({
        type: LISTING,
        payload:data
...
export const signup = (first_name, last_name, email, password, re_password, cell_number) => async dispatch => {
    const config = {
        headers: {
            'Content-Type': 'application/json'
        }
    ...
    const body = JSON.stringify({ first_name, last_name, email, password, re_password, cell_number });
