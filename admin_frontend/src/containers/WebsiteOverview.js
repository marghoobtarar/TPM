...
const WebsiteOverview = ({ logout, isAuthenticated }) => {
  ...
  useEffect(() => {
    axios({
      method: "GET",
      url: `${process.env.REACT_APP_API_URL}/admin_app/website_overview/`,
      headers: {
  ...
  const onsubmit = (e) => {
    console.log(id, heading, description2, description);
    e.preventDefault();
    ...
    if (heading === "" || !heading) {
      ...
      var method = "PUT";
      var url = `manage_website_overview/${id}`;
      if (id === "") {
        method = "POST";
              ...
              <ul className="list-inline menu-left mb-0">
                ...
                <li>
                  <div className="page-title-box">
                    <h4 className="page-title">Website Overview</h4>
...
export default connect(mapStateToProps, { logout })(WebsiteOverview);
