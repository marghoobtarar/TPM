    ...
    def post(self, request, *args, **kwargs):
        ...
        if key_lookup in request.data:
            try:
                ...
                try:
                    User.objects.get(email = request.data['email'] , is_active=True)

                except:
                    
                    return Response({"detail":"Please activate your account for login."}, status=status.HTTP_401_UNAUTHORIZED)
                else:
